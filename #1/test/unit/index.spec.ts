...
describe('#calculateAccountBalance', function () {
  it('SHOULD return the correct balance of the account', function () {
    [
      ...
      expect(calculateAccountBalance(AccountEvents, data.account)),(data.balance);
    });
  });
});
...
describe('#getAccountInformation', function () {
  it('SHOULD retrieve the correct account information', function () {
    ...
    expect(getAccountInformation(AccountEvents, '60329145-ba86-44fb-8fc8-519e1e427a60')),({
      username: 'jdoe',
      fullName: 'johndoe',
    ...
    [
      ...
      expect(getAccountInformation(AccountEvents, data.account)),(data.info);
    });
  });
});